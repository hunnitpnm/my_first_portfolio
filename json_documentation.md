...
### Схема связей между типами массивов API

![Схема связей между типами данных API](https://github.com/hunnitpnm/my_first_portfolio/blob/main/learning/1%20(3).png)
...
| 201 | Новый ресурс успешно добавлен         |
| 404 | Запрашиваемая информация не была найдена |

Частая причина ошибки 404 - неверная ссылка и/или не подходящий тип запроса. В таком случае ответом будет пустой словарь. 
...
```python
{}      # возвращает пустой словарь
<bound method Response.json of <Response [404]>>  # код 404, запрос не выаолнен, так как нет данных
```
---
